...
const ChooseUs = () => {
  return <section>
    <Container>
        <Row>
            <Col lg='6' md='6'>
                <img src={pastaImg} alt="pasta-img" className='w-100' />
            </Col>
            <Col lg='6' md='6'>
                <div className="choose__content">
                    <h4>Who we are?</h4>
                    <h2>Take a look at the benefits offer you</h2>
                ...
                <div className="features mt-4">
                    ...
                    <div className="feature1 mt-3 d-flex align-items-center gap-5">
                        <div className="single__feature">
                            <span className='feature__icon-3'><i className='ri-secure-payment-line'></i></span>
